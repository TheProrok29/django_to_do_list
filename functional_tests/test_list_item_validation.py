...
class ItemValidationTest(FunctionalTest):
    ...
    def test_cannot_add_empty_list_items(self):
        # Tom goes to the home page and accidentally tries to submit
    ...
    def test_cannot_add_duplicate_items(self):
        # Tom goes to the home page and starts a new list
        self.browser.get(self.live_server_url)
        self.get_item_input_box().send_keys('Learn django')
        self.get_item_input_box().send_keys(Keys.ENTER)
    ...
    def test_error_messages_are_cleared_on_input(self):
        # Tom starts a ;ist and causes a validation error:
        self.browser.get(self.live_server_url)
        self.get_item_input_box().send_keys('Go to work')
        self.get_item_input_box().send_keys(Keys.ENTER)
        self.wait_for_row_in_list_table('1: Go to work')
        self.get_item_input_box().send_keys('Go to work')
        self.get_item_input_box().send_keys(Keys.ENTER)
